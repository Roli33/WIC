...
-- at runtime using the environment variable WIC_bindir.
...
-- environment variable WIC_libdir.
...
-- using the environment variable WIC_dynlibdir.
...
-- runtime using the environment variable WIC_datadir.
...
-- using the environment variable WIC_sysconfdir.
...
bindir     = "D:\\cabal\\bin"
libdir     = "D:\\cabal\\x86_64-windows-ghc-9.14.1-bd8b\\WIC-0.1.0.0-inplace-wic-tests"
dynlibdir  = "D:\\cabal\\x86_64-windows-ghc-9.14.1-bd8b"
datadir    = "D:\\cabal\\x86_64-windows-ghc-9.14.1-bd8b\\WIC-0.1.0.0"
libexecdir = "D:\\cabal\\WIC-0.1.0.0-inplace-wic-tests\\x86_64-windows-ghc-9.14.1-bd8b\\WIC-0.1.0.0"
sysconfdir = "D:\\cabal\\etc"

getBinDir     = catchIO (getEnv "WIC_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "WIC_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "WIC_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "WIC_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "WIC_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "WIC_sysconfdir") (\_ -> return sysconfdir)
